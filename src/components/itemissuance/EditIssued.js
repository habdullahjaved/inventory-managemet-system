...
const EditIssued = () => {
  ...
  const getIssuedbyId = async (id) => {
    try {
      await axios
        .get(`${API_LINK}equipment-issuances/${id}`)
  ...
  const handleSubmit = async (e, id) => {
    ...
    try {
      await axios
        .put(`${API_LINK}equipment-issuances/${id}`, item)
        .then((res) => {
  ...
  return (
    <div className='page-wrapper p-2'>
      <h2 className='page-title'>Edit Issuance</h2>
